...
<html>
	...
	<head>
		...
		<link href="${ctx}/staticfile/bd/css/refstyle.css" rel="stylesheet" type="text/css">
						...
						<div class="refund-aside">
							<div class="item-pic">
								<a href="#" class="J_MakePoint">
									<img src="${ctx}/staticfile/bd/images/comment.jpg_400x400.jpg" class="itempic">
								</a>
							</div>
						...
						<div class="refund-main">
							...
							<div class="refund-tip">
								<div class="filePic">
									...
									<img src="${ctx}/staticfile/bd/images/image.jpg" alt="">
								</div>
