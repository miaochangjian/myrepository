...
<html>
	...
	<head>
		...
		<link href="${ctx}/staticfile/bd/css/blstyle.css" rel="stylesheet" type="text/css">
									...
									<div class="card-chart valid">
										<div class="cards-carousel">
											<div class="mask">
												...
												<div class="bank ng-binding" style="background-image: url(${ctx}/staticfile/bd/images/combo.png);">中国农业银行</div>
												<div class="details">
													<a>查看详情</a>
												</div>
											</div>
										...
										<div class="cards-details">
											<div class="bank-name">
												<div class="name fn-left" style="background-image: url(${ctx}/staticfile/bd/images/combo.png);"></div>
